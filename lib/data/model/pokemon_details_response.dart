...
PokemonDetailsResponse pokemonDetailsResponseFromJson(String str) =>
    PokemonDetailsResponse.fromJson(json.decode(str));

String pokemonDetailsResponseToJson(PokemonDetailsResponse data) =>
