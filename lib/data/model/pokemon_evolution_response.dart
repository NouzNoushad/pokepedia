...
//
//     final pokemonEvolutionResponse = pokemonEvolutionResponseFromJson(jsonString);

import 'dart:convert';

PokemonEvolutionResponse pokemonEvolutionResponseFromJson(String str) =>
    PokemonEvolutionResponse.fromJson(json.decode(str));

String pokemonEvolutionResponseToJson(PokemonEvolutionResponse data) =>
