...
//
//     final pokemonSpeciesResponse = pokemonSpeciesResponseFromJson(jsonString);

import 'dart:convert';

PokemonSpeciesResponse pokemonSpeciesResponseFromJson(String str) =>
    PokemonSpeciesResponse.fromJson(json.decode(str));

String pokemonSpeciesResponseToJson(PokemonSpeciesResponse data) =>
